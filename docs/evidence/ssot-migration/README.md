...
Os testes usam repositórios temporários e cobrem reescrita de snapshots, remoção de registros, ciclos, herança de classificação, falhas de publicação e numeração de sucessores. Eles não alteram o archive publicado.
